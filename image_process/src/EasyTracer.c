...
//	Rgb->blue  =   (unsigned char)((C16&0x001f)<<3);
	...
	Rgb->red   =	 (unsigned char)((float)((C16&0xf800)>>11)/0x1F*0xFF);
	Rgb->green =	 (unsigned char)((float)((C16&0x07e0)>>5)/0x3F*0xFF);
	Rgb->blue  =   (unsigned char)((float)((C16&0x001f/0x1F)*0xFF));
	
//		Rgb->red   =	 (unsigned char)((C16&0xf800)>>11);
//		Rgb->green =	 (unsigned char)((C16&0x07e0)>>5);
//		Rgb->blue  =   (unsigned char)((C16&0x001f)<<3);
}
